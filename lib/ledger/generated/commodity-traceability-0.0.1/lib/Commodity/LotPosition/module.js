...
exports.AcceptTransfer = {
  decoder: damlTypes.lazyMemo(function () {
    return jtv.object({
      occurredAt: damlTypes.Text.decoder,
    });
  }),
  encode: function (__typed__) {
    return {
      occurredAt: damlTypes.Text.encode(__typed__.occurredAt),
    };
  },
};
...
exports.CombineLots = {
  decoder: damlTypes.lazyMemo(function () {
    return jtv.object({
      otherLotCid: damlTypes.ContractId(exports.LotPosition).decoder,
      combinedLotId: damlTypes.Text.decoder,
    });
  }),
  encode: function (__typed__) {
    return {
      otherLotCid: damlTypes.ContractId(exports.LotPosition).encode(__typed__.otherLotCid),
      combinedLotId: damlTypes.Text.encode(__typed__.combinedLotId),
    };
  },
};
...
exports.CustodyTransfer = damlTypes.assembleTemplate(
  {
    ...
    templateIdWithPackageId: '#b8a4d450d2bfc6083baee7c4b059e8ad17ba996f8219d1d0aa114074e0b63294:Commodity.LotPosition:CustodyTransfer',
    ...
    decoder: damlTypes.lazyMemo(function () {
      return jtv.object({
        ...
        provenance: damlTypes.List(exports.ProvenanceEntry).decoder,
    ...
    encode: function (__typed__) {
      return {
        ...
        provenance: damlTypes.List(exports.ProvenanceEntry).encode(__typed__.provenance),
...
damlTypes.registerTemplate(exports.CustodyTransfer, ['b8a4d450d2bfc6083baee7c4b059e8ad17ba996f8219d1d0aa114074e0b63294', '#commodity-traceability']);
...
exports.LotPosition = damlTypes.assembleTemplate(
  {
    ...
    templateIdWithPackageId: '#b8a4d450d2bfc6083baee7c4b059e8ad17ba996f8219d1d0aa114074e0b63294:Commodity.LotPosition:LotPosition',
    keyDecoder: jtv.constant(undefined),
    keyEncode: function () { throw 'EncodeError'; },
    decoder: damlTypes.lazyMemo(function () {
      return jtv.object({
    ...
    CombineLots: {
      template: function () { return exports.LotPosition; },
      choiceName: 'CombineLots',
      argumentDecoder: damlTypes.lazyMemo(function () {
        return exports.CombineLots.decoder;
      }),
      argumentEncode: function (__typed__) { return exports.CombineLots.encode(__typed__); },
      resultDecoder: damlTypes.lazyMemo(function () {
        return damlTypes.ContractId(exports.LotPosition).decoder;
      }),
      resultEncode: function (__typed__) { return damlTypes.ContractId(exports.LotPosition).encode(__typed__); },
...
damlTypes.registerTemplate(exports.LotPosition, ['b8a4d450d2bfc6083baee7c4b059e8ad17ba996f8219d1d0aa114074e0b63294', '#commodity-traceability']);

exports.ProvenanceEntry = {
  decoder: damlTypes.lazyMemo(function () {
    return jtv.object({
      fromParty: damlTypes.Party.decoder,
      toParty: damlTypes.Party.decoder,
      transferId: damlTypes.Text.decoder,
      evidenceHashes: damlTypes.List(damlTypes.Text).decoder,
      occurredAt: damlTypes.Text.decoder,
    });
  ...
  encode: function (__typed__) {
    return {
      fromParty: damlTypes.Party.encode(__typed__.fromParty),
      toParty: damlTypes.Party.encode(__typed__.toParty),
      transferId: damlTypes.Text.encode(__typed__.transferId),
      evidenceHashes: damlTypes.List(damlTypes.Text).encode(__typed__.evidenceHashes),
      occurredAt: damlTypes.Text.encode(__typed__.occurredAt),
    };
